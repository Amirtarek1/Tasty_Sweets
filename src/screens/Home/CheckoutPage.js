...
// **
// on that page                                
// 1- make a onchange text that for add note  x
...
import { View, Text, Switch, Dimensions, TextInput, TouchableOpacity, FlatList, Image } from 'react-native';
...
const CheckoutPage = () => {
    ...
    const [Totalfee, setTotalfee] = useState(cart_products.reduce((sum, product) => sum + product.price_delivery * product.product_count, 0));
    ...
    const increment = async (product_id) => {
        ...
        setTotalfee(prevTotalfee => prevTotalfee+ updatedProducts.find(product => product.product_id === product_id).price_delivery);
    ...
    const deleteProduct = (product_id) => {
        ...
        setTotalfee((prevTotalfee) => prevTotalfee - deletedProduct.price_delivery * deletedProduct.product_count);
                ...
                <View style={{ flex: 1, backgroundColor: COLORS.white }}>
                            ...
                            if (item.type === 'header') {
                                return (
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <View>
                                                ...
                                                <TextInput
                                                    ...
                                                    value={addnote}
                                                    onChangeText={value => { setaddnotes(value) }}
                                                />
                                            </View>
                                        ...
                                        <View style={{
                                            marginTop: RFPercentage(2),
                                            padding: RFPercentage(0.5), flexDirection: "row", justifyContent: "space-between"
                                        }}>
                                            <Text style={{
                                                fontFamily: FONT.Quicksand_Bold, fontSize: RFPercentage(3.5),
                                                color: COLORS.TextColorName
                                            }}>My Cart</Text>
                                ...
                                return (
                                    <View style={{ backgroundColor: COLORS.white }}>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            style={{
                                                backgroundColor: COLORS.Detalis_product_name,
                                                borderRadius: RFPercentage(1),
                                            ...
                                            <Text style={{ color: COLORS.white, fontFamily: FONT.Quicksand_Bold }}>
                                                {showAllItems ? 'Show First Item' : 'Show All Items'}
                                            </Text>
                                        </TouchableOpacity>
                                    </View>
                                );
                    ...
                    <View style={{ padding: RFPercentage(2) }}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            ...
                            <Text style={{
                                fontFamily: FONT.Quicksand_SemiBold, fontSize: RFPercentage(2.4),
                                color: COLORS.TextColorName
                            }}>Items Total price</Text>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <Text style={{
                                fontFamily: FONT.Quicksand_SemiBold, fontSize: RFPercentage(2.2),
                                color: COLORS.TextColorName
                            }}>Delivery fee</Text>
